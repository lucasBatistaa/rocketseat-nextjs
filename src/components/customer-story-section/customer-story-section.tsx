    ...
    return (
        <section className="container py-8 md:py-10">
            <div className="flex flex-col items-center gap-8 md:gap-12">
                <h2 className={`${ptSansCaption} text-heading-md md:text-heading-xl text-gray-100`}>
                    Quem utiliza, aprova!
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                    {
                        customerStories.map((customerStory) => (
                            <div
                                ...
                                className="flex flex-col gap-8 md:gap-10 justify-between bg-gray-600 border-[1px] border-gray-400 p-6 md:p-10 rounded-xl "
                            >
